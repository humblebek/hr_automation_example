...
VALUES ('Qoraqalpog‘iston Respublikasi'),
       ('Andijon viloyati'),
       ('Buxoro viloyati'),
       ('Jizzax viloyati'),
...
ALTER TABLE "districts" ALTER COLUMN "id" SET DATA TYPE BIGINT;
ALTER SEQUENCE districts_id_seq RESTART WITH 1;


ALTER TABLE "regions" ALTER COLUMN "id" SET DATA TYPE BIGINT;
