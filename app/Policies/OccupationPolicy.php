...
class OccupationPolicy
{
    ...
    {
        return $user->can('view_any_occupation');
    }
    ...
    {
        return $user->can('view_occupation');
    }
    ...
    {
        return $user->can('create_occupation');
    }
    ...
    {
        return $user->can('update_occupation');
    }
    ...
    {
        return $user->can('delete_occupation');
    }
    ...
    {
        return $user->can('delete_any_occupation');
    }
     ...
     */
    public function replicate(User $user, Occupation $occupation): bool
    {
